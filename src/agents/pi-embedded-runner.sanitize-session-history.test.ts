        ...
        content: [
          {
            type: "thinking",
            thinking: "internal",
            // Valid standard base64 — Anthropic thinking signatures are base64-encoded.
            // "some_sig" would be treated as unsigned (contains "_" which is URL-safe
            // base64 but not standard base64 accepted by the Anthropic API).
            thinkingSignature: "c29tZXNpZw==",
          },
          { type: "text", text: "hi" },
        ],
      },
